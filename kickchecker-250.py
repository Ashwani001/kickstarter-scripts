...
def get_avail(page):
    before_start = page.find('$250 USD')#ensure start and end are same as yours (view page source)
    quote_start = page.find('<span class="num-backers mr1">',before_start+1)#ensure start and end are same as yours (view page source)
